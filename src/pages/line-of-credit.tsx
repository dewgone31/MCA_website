...
export default function LineOfCreditPage() {
  return (
    <PageContainer>
      <Head>
        <title>Line of Credit - {process.env.NEXT_PUBLIC_COMPANY_NAME}</title>
      </Head>
      <Hero>
        <HeroContent>
          <HeroText>
            <HeroTitle>Draw as you need and only pay for what you draw​</HeroTitle>
            <HeroSubtitle>
              Flexible, on-demand business funding with no hidden fees.
            </HeroSubtitle>
          </HeroText>
          <HeroImageWrapper>
            <HeroImage src="/images/money-cash.jpg" alt="Stack of $100 bills" />
          </HeroImageWrapper>
        </HeroContent>
      </Hero>
